...
/*
    ...
    Description: count post content
    Version: 1.0
    Author: Lincoln
...
class WordCountAndTimePlugin
{
        ...
        return $content;
            ...
            function createHTML($content){
                ...
                if(get_option( "wcp_readtime", "1") ){
                    $html .= "This post will take about". " " . round($wordcount/100) . " " ."minutes(s) to read.<br>";
                }
    ...
    function sanitizeLocation($input){
        ...
        {
            add_settings_error( "wcp_location", 
            "wcp_location_error", 
    ...
    { ?>
        ...
        value="1" <?php 
        checked(get_option($args["theName"]), 1) ?>>
    <?php }
    ...
    function adminPage()
    {
        add_options_page(
            ...
            "manage_options",
            "word-count-settings-page",
            array($this, "ourSettingsPageHtml")
        );
    }
